...
import os
os.environ['TRANSFORMERS_CACHE'] = '/projects/arsr9646/huggingface'
...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.pretrain,cache_dir='/projects/arsr9646/huggingface')
    logger.info("loading validation set")
    validset_reader = DataLoaderTest(args, label_map, tokenizer, batch_size=args.batch_size)
    logger.info('initializing estimator model')
    bert = AutoModel.from_pretrained(args.pretrain,cache_dir='/projects/arsr9646/huggingface').cuda()
    bert = bert.cuda()
    bert.eval()
